...
// 好，现在我要你做两件事，一是先将现如今的代码上传到 github 进行版本备份，以防你改错后无法找到原先的代码；二 将 png.js 删除后，进行功能测试，对比删除前后的值是否相同，功能是否正常，都正常的话，写一个 md
//   文档，里面只需要写这几件事情，什么情况下会出现调用返回 null, 给出例子，如何避免这种情况，你要说请吃